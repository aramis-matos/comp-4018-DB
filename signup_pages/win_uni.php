...
<head>
    ...
    <title>Win the University Competition</title>
</head>

<body>
    <fieldset>
        <legend>Win the University Competition Data Insert</legend>
        <form action="../includes/win_uni.inc.php" method="POST">
    ...
    <fieldset>
        <legend>Win the University Competition Data View</legend>
        <form action="../includes/win_uni.inc.php" method="POST">
    ...
    <fieldset>
        <legend>Win the University Competition Data Modify</legend>
        <form action="../includes/win_uni.inc.php" method="POST">
