...
ALTER TABLE has_selec DROP exan_id;

ALTER TABLE has_selec ADD exam_id int(11) not null;
...
ALTER TABLE team_open_ans DROP selec_id;

ALTER TABLE team_open_ans add open_id int(11) not null;
